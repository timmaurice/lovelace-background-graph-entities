      ...
      <div class="card-config">
        ...
        ${t.auto_icon_color?G`
              <div class="dropdown-wrapper" style="margin-top: 8px;">
                <ha-dropdown
                  @wa-select=${t=>h("auto_icon_color_source",t.detail.item.value)}
                >
                  ...
                  <ha-dropdown-item value="latest">${s("latest")}</ha-dropdown-item>
                  <ha-dropdown-item value="max">${s("max")}</ha-dropdown-item>
                  <ha-dropdown-item value="min">${s("min")}</ha-dropdown-item>
                </ha-dropdown>
              </div>
            `:""}
        ...
        ${o?G`
              <div class="dropdown-wrapper" style="margin-top: 8px;">
                <ha-dropdown
                  @wa-select=${t=>h("value_source",t.detail.item.value)}
                >
                  <div slot="trigger" class="dropdown-trigger">
                    <ha-textfield
                      readonly
          ...
          >
            <div slot="trigger" class="dropdown-trigger">
              <ha-textfield
                ...
                .value=${Bo(this.hass,"single"===n?"component.bge.editor.color_mode_single":"component.bge.editor.color_mode_threshold")}
                iconTrailing
                class="dropdown-textfield"
              >
                <ha-icon slot="trailingIcon" icon="mdi:menu-down"></ha-icon>
            ...
            <ha-dropdown-item value="single"
              >${Bo(this.hass,"component.bge.editor.color_mode_single")}</ha-dropdown-item
            >
            <ha-dropdown-item value="threshold"
              >${Bo(this.hass,"component.bge.editor.color_mode_threshold")}</ha-dropdown-item
            >
          </ha-dropdown>
        </div>
            ...
            >
              <div slot="trigger" class="dropdown-trigger">
                <ha-textfield
                  ...
                  .value=${"short"===this._config.line_length?Bo(this.hass,"component.bge.editor.line_length_short"):Bo(this.hass,"component.bge.editor.line_length_long")}
                  iconTrailing
                  class="dropdown-textfield"
                >
                  <ha-icon slot="trailingIcon" icon="mdi:menu-down"></ha-icon>
              ...
              <ha-dropdown-item value="long"
                >${Bo(this.hass,"component.bge.editor.line_length_long")}</ha-dropdown-item
              >
              <ha-dropdown-item value="short"
                >${Bo(this.hass,"component.bge.editor.line_length_short")}</ha-dropdown-item
              >
            </ha-dropdown>
          </div>
          <div class="dropdown-wrapper" style="margin-top: 8px;">
            ...
            >
              <div slot="trigger" class="dropdown-trigger">
                <ha-textfield
                  ...
                  .value=${"linear"===this._config.curve?Bo(this.hass,"component.bge.editor.curve_linear"):"natural"===this._config.curve?Bo(this.hass,"component.bge.editor.curve_natural"):"step"===this._config.curve?Bo(this.hass,"component.bge.editor.curve_step"):Bo(this.hass,"component.bge.editor.curve_spline")}
                  iconTrailing
                  class="dropdown-textfield"
                >
                  <ha-icon slot="trailingIcon" icon="mdi:menu-down"></ha-icon>
              ...
              <ha-dropdown-item value="spline"
                >${Bo(this.hass,"component.bge.editor.curve_spline")}</ha-dropdown-item
              >
              <ha-dropdown-item value="linear"
                >${Bo(this.hass,"component.bge.editor.curve_linear")}</ha-dropdown-item
              >
              <ha-dropdown-item value="natural"
                >${Bo(this.hass,"component.bge.editor.curve_natural")}</ha-dropdown-item
              >
              <ha-dropdown-item value="step"
                >${Bo(this.hass,"component.bge.editor.curve_step")}</ha-dropdown-item
              >
            </ha-dropdown>
          </div>
        </div>
            ...
            >
              <div slot="trigger" class="dropdown-trigger">
                <ha-textfield
                  readonly
                  .label=${Bo(this.hass,"component.bge.editor.color_mode")}
                  .value=${Bo(this.hass,"single"===t?"component.bge.editor.color_mode_single":"component.bge.editor.color_mode_threshold")}
                  iconTrailing
                  class="dropdown-textfield"
                >
                  <ha-icon slot="trailingIcon" icon="mdi:menu-down"></ha-icon>
